<x-layout title="Novo Hábito • Loggher">
        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white/60 border border-[#071013]/10 rounded-2xl shadow-lg p-8">
                ...
                <div class="text-center mb-8">
                    <h2 class="text-3xl font-bold text-[#071013]">Criar novo hábito</h2>
                ...
                {{-- Form --}}
                <form action="{{ route('habit.submit') }}" method="POST" class="space-y-6">
                    @csrf
